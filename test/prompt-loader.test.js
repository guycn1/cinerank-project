...
test('loadPrompt: taste_verdict_v6 keeps its RATED_MOVIES slot and injection markers', async () => {
  const { user } = await loadPrompt('taste_verdict_v6', { RATED_MOVIES: 'SEED_LIST' });
