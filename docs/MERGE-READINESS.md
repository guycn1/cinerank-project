...
* **Trajectory** — an unbroken commit history from the very first commit, 25 merges
  ...
  cannot resolve, and the twenty-fifth carried the merge rule itself, which had
  gone out of date while the practice it describes stayed consistent — and
